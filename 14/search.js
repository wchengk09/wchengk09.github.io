const DataBase = [
    ...
    ['打败王梓豪2（pkwzh2）','可用于训练数学整式加减。','/14/games/pkwzh2/','search/math.png',true],
    ...
    ['快问快答（quickqa）','#游戏（games）','/14/games/quickqa','search/ques.png',true],
    ['找不同（super）','#游戏（games）','/14/games/super','search.jpeg',true],
